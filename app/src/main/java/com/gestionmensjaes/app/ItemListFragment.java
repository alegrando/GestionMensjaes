...
import com.gestionmensjaes.app.data.BDMensajes;
...
public class ItemListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        JgDownloadParseXML jgDownloadParseXML = new JgDownloadParseXML(context, this);
        jgDownloadParseXML.execute("http://alegrando.byethost24.com/mensajes.xml");
        mostrarListaMensajes();
    }

    public void mostrarListaMensajes(){
        BDMensajes bdMensajes = new BDMensajes(context);
        MensajesList.setMensajesList(bdMensajes.list());

        // TODO: replace with a real list adapter.
        setListAdapter(new ArrayAdapter<Mensajes>(
                getActivity(),
                android.R.layout.simple_list_item_activated_1,
                android.R.id.text1,
                MensajesList.getMensajesList()));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        Log.d(ItemListFragment.class.getName(), "Se ha detectado clic en el registro con posición: " + position);
